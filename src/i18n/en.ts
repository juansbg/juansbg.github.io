...
export const en: Strings = {
  ...
  ui: {
    ...
    paper: {
      ...
      headline: {
        killers: (name) => `${name} found dead`,
        rogue: (name) => `A second body: ${name}`,
        poison: (name) => `${name} poisoned`,
        lynch: (name) => `Town hangs ${name}`,
        heartbreak: (name) => `${name} follows`,
        revenge: (name) => `${name} shot by the Gunman`,
      },
      event: {
        silenced: (name) => `Fire at ${name}'s: not a word from them today`,
        extraVote: (name) => `A word against ${name}`,
        growl: 'A growl at the table',
        cardTaken: (role) => `${role}'s card gone from the centre`,
        clue: ['Heard on the street', 'A word from a neighbour', 'Somebody was awake'],
      },
      investigation: {
        PLAIN: [
