...
export const en: Strings = {
  ...
  roles: {
    ...
    ROGUE: { name: 'The Renegade', prompt: 'Picks another victim — his own side included.' , brief: 'On even nights you pick another victim. It can be anyone — your own side included.' },
    PICK_SIDE: { name: 'The Associate', prompt: 'Decides which side he is on.' , brief: 'On the first night you decide whether to join the Family or stay with the town.' },

    // ---- The town ----
    PLAIN: { name: 'The Citizen', prompt: 'Sleeps.' , brief: 'You have no ability. Your only weapon is the conversation — work out who is lying.' },
    INSPECT: { name: 'The Detective', prompt: 'Points at someone — show them that card.' , brief: 'Each night you pick someone and the narrator secretly shows you their card.' },
    GUARD: {
      name: 'The Bodyguard',
    ...
    SURVIVE: { name: 'The Veteran', prompt: 'Survives the first attempt on his life.' , brief: 'You survive the first attempt on your life. The second one kills you.' },
    ...
    PROTEGE: { name: 'The Orphan', prompt: 'Chooses a mentor. If the mentor is killed, he joins the Family.' , brief: 'On the first night you choose a mentor. If they are killed, you join the Family.' },
    SENSE: { name: 'The Bloodhound', prompt: 'Growls when a killer is sitting beside him.' , brief: 'Each morning the town is told whether a killer is sitting right beside you.' },
    AVENGE: { name: 'The Gunman', prompt: 'Takes someone with him when he dies.' , brief: 'When you die, you take someone down with you — your choice.' },
    MARTYR: { name: 'The Martyr', prompt: 'Wins if the town executes him.' , brief: 'You win if you get the town to execute you. Being killed at night does not count.' },
    ...
    PEEK: { name: 'The Witness', prompt: 'Opens their eyes while the Family is awake.' , brief: 'You may open your eyes while the Family is awake. If you are caught, you are dead.' },
    SPLIT: { name: 'The Cultist', prompt: 'Splits the town into two factions.' , brief: 'On the first night you split the town into two opposing factions.' },
  },
